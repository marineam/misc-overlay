...
# $Header: /var/cvsroot/gentoo-x86/app-emulation/xen-tools/Attic/xen-tools-3.4.2-r5.ebuild,v 1.7 2012/12/04 12:00:12 idella4 dead $
...
SLOT="0"
KEYWORDS="amd64 x86"
IUSE="doc debug custom-cflags pygrub hvm api acm flask"
...
PATCHES=(
	...
	"${FILESDIR}/${PN}-3.4.2-as-needed.patch"
	"${FILESDIR}/xen-${PV}-werror.patch"
)
...
src_prepare() {
	...
	if ! use hvm; then
		...
		sed -i -e 's%: tools/ioemu-dir$%:%' "${S}"/Makefile
	fi
